    ...
    <div className="prose dark:prose-invert">
      <div className="mt-4">
        ...
        <p>
          ...
          esplorando il corpo come mezzo di espressione e comunicazione. Con il
          tempo, però, ho sentito il bisogno di andare oltre la performance e la
          tecnica, alla ricerca di qualcosa di più profondo. La danza non era
          più solo un atto esteriore, ma un viaggio interiore che coinvolge
          emozioni, respiro e consapevolezza.
          <br />
          È così che ho scoperto la danza somatica: un approccio che mi ha
